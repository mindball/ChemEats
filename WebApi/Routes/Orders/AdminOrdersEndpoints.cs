...
public static class AdminOrdersEndpoints
{
    ...
    {
        RouteGroupBuilder group = app.MapGroup("/api/admin/mealorders")
            .RequireAuthorization("AdminPolicy");

        group.MapGet("/unpaid/{userId}", async (
                string userId,
                Guid? supplierId,
        ...
        group.MapGet("/period/{userId}", async (
                string userId,
                DateTime? startDate,
                DateTime? endDate,
                Guid? supplierId,
